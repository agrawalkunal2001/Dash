...
class UserModel {
  final String email;
  final String name;
  final List<String> followers; // List of uid of followers
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bannerPic': bannerPic,
      //'uid': uid, // uid is not to be stored on appwrite as it creates a unique id itself
      'bio': bio,
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      uid: map['\$id']
          as String, // uid is stored as id on appwrite. This will retrieve it
